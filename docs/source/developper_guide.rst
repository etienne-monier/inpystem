...
This section just give some informations about the children classes of :class:`~.signals.Stem2D` and :class:`~.signals.Stem3D` that helps me to develop algorithms. 
